...
public class CustomerDashboard implements MouseListener {
	...
	public CustomerDashboard(int id, String fullname) {
		ID = id;
		FullName = fullname;
		...
		usertitle1.setBounds(50,30,150,30);
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getSource()==table) {
			try {
				...
				int id = (int) model.getValueAt(sRows, 2);
				txtbookingid.setText(Integer.toString(id));
